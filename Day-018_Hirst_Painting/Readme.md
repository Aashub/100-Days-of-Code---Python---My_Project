...
* How to navigate Python documentation to understand methods like .dot(),and .penup() and how to use them
...
* Second for loop is help to draws a horizontal line of 27 randomly colored dots.
* the First for loop helps to resets the turtle y-position upword after each line to start a new row.
* The loop repeats this process to create a 27x27 dot grid pattern.
