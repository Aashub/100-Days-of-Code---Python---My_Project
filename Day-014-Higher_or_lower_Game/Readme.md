...
- The game continues until the player don't decide to exit the game.

## Code Highlights  
- **assigning_data_a(comp_a) and assigning_data_b(comp_b):** Functions that randomly select and display public figures details.  
- **Data Manipulation:** Moves Compare B to Compare A and selects a new Compare B for the next round.  
