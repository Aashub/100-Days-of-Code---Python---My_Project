...
## Overview
Day 13 learning was focused on how to identify, analyze, and fix errors in Python programs. I learned different debugging techniques to understand why code behaves unexpectedly and how to resolve them out. Which  helped me to understand how to do debugging by analyzing logic, tracing code execution, and using both manual and tool-based methods to find and fix bugs.
