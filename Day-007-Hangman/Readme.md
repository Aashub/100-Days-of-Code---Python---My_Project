...
## Code Highlights
- Learned how to use for loop inside the while loop and update the data while keeping the previously updated data as it is. 
- Tracks player progress and updates the displayed word in real-time.
- Includes a lives left counter to limit incorrect guesses.
